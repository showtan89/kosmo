...
public class onedayclassVO {
	...
	private String onedayclassRecruitment;		// 원데이클래스 모집인원
	...
	private String onedayclassEndCheck;			// 원데이클래스 종료여부
	...
	public String getOnedayclassRecruitment() {
		return onedayclassRecruitment;
	}
	public void setOnedayclassRecruitment(String onedayclassRecruitment) {
	...
	public String getOnedayclassEndCheck() {
		return onedayclassEndCheck;
	}
	public void setOnedayclassEndCheck(String onedayclassEndCheck) {

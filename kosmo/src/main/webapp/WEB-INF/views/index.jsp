            ...
            <div class="container h-100">
               <div class="row h-100 align-items-center">
                  <div class="col-12">
                     <!-- Post Content -->
                     <div class="hero-slides-content text-center">
                        <h2>The opening of Gyeongbokgung Palace, a beautiful old palace in Korea,
                            has begun. Feel the feeling of the king in a beautiful
               ...
               <div class="single-product-area mb-50 wow fadeInUp"
                  ...
                  <div class="product-img">
                     ...
                     <div class="product-meta d-flex">
                        ...
                        <a href="cart.jsp" class="add-to-cart-btn">Add to cart</a> <a
      ...
      <div class="container">
         ...
         <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-6 col-lg-4">
               <div class="single-blog-post mb-100">
                  <div class="post-thumbnail mb-30">
                     <a href="single-post.jsp"><img src="resources/img/bg-img/6.jpg" alt=""></a>
                  </div>
                  <div class="post-content">
                     <a href="single-post.jsp" class="post-title">
            ...
            <div class="col-12 col-md-6 col-lg-4">
               <div class="single-blog-post mb-100">
                  <div class="post-thumbnail mb-30">
                     <a href="single-post.jsp"><img src="resources/img/bg-img/7.jpg" alt=""></a>
                  </div>
                  <div class="post-content">
                     <a href="single-post.jsp" class="post-title">
                        <h5>2018 Midwest Tree and Shrub Conference: Resilient
                           Plants for a Lasting Landscape</h5>
                     </a>
                     <div class="post-meta">
                        <a href="#"><i class="fa fa-clock-o" aria-hidden="true"></i>
                           20 Jun 2018</a> <a href="#"><i class="fa fa-user"
            ...
            <div class="col-12 col-md-6 col-lg-4">
               <div class="single-blog-post mb-100">
                  <div class="post-thumbnail mb-30">
                     <a href="single-post.jsp"><img src="resources/img/bg-img/8.jpg" alt=""></a>
                  </div>
                  <div class="post-content">
                     <a href="single-post.jsp" class="post-title">

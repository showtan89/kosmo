							...
							<div id="product_details_slider" class="carousel slide"
								...
								<div class="carousel-inner">
									...
									<div class="carousel-item">
										...
										<img class="d-block w-100" src="${realimage}${rVO.realestateImg3}" alt="1">
										<!-- </a> -->
									</div>
									</c:if>
								</div>
								<ol class="carousel-indicators">
									<c:if test="${!rVO.realestateImg2.equals('empty') && !rVO.realestateImg3.equals('empty')}">
									<li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(${realimage}${rVO.realestateImg1});"></li>
									</c:if>
									<c:if test="${!rVO.realestateImg2.equals('empty')}">
									<li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(${realimage}${rVO.realestateImg2});"></li>
									</c:if>
									<c:if test="${!rVO.realestateImg3.equals('empty')}">
									<li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(${realimage}${rVO.realestateImg3});"></li>
									</c:if>
								</ol>
							</div>
						</div>
	...
	realestateImg3=empty, 
	 -->
							<div class="description_area">
								...
								<p>
									<span>Management fees per Week : </span> <span>
									<fmt:setLocale value="ko_KR" />
							 ...
							 <div class="single-widget-area products--meta">
								 <ol class="popular-tags d-flex flex-wrap">
								 	...
								 	<c:if test="${rVO.realestateCategory1.equals('chungcheongbuk')}">
								 		<li><a>Chungcheongbuk-do (충청북도)</a></li>
								 	</c:if>
								 	<c:if test="${rVO.realestateCategory1.equals('chungcheongnam')}">
				...
				<div class="col-12">
					<div class="product_details_tab clearfix">
						...
						<ul class="nav nav-tabs" role="tablist" id="product-details-tab">
							<li class="nav-item"><a href="#description"	class="nav-link active" data-toggle="tab" role="tab">
								Additional Information</a></li>
							<li class="nav-item"><a href="#reviews" class="nav-link" data-toggle="tab" role="tab"> 
								Comments <span class="text-muted">(1)</span></a></li>
						</ul>
						<!-- Tab Content -->

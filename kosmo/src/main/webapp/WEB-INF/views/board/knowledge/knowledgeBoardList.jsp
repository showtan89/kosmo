		...
		<div class="col-12 col-md-3 col-lg-2">
			<div class="shop-sidebar-area">
				<div class="shop-widget catagory mb-50" align="left">
					...
					<h6 class="widget-title"><a id="knowledgeCategoryAll" href="knowledgeBoardList?knowledgeCategory=All">All</a></h6>
						<h6 class="widget-title"><a id="Education" href="knowledgeBoardList?knowledgeCategory=Education">Education</a></h6>
						...
						<h6 class="widget-title"><a id="entertainment" href="knowledgeBoardList?knowledgeCategory=entertainment">Entertainment</a></h6>
						<h6 class="widget-title"><a id="life" href="knowledgeBoardList?knowledgeCategory=life">Life</a></h6>
						<h6 class="widget-title"><a id="Health" href="knowledgeBoardList?knowledgeCategory=Health">Health</a></h6>
						<h6 class="widget-title"><a id="society" href="knowledgeBoardList?knowledgeCategory=society">Society</a></h6>
						<h6 class="widget-title"><a id="travel" href="knowledgeBoardList?knowledgeCategory=travel">Travel</a></h6>
						<h6 class="widget-title"><a id="sports" href="knowledgeBoardList?knowledgeCategory=sports">Sports</a></h6>
						<h6 class="widget-title"><a id="Shopping" href="knowledgeBoardList?knowledgeCategory=Shopping">Shopping</a></h6>
						<h6 class="widget-title"><a id="Question" href="knowledgeBoardList?knowledgeCategory=Question">Question</a></h6>
				</div>
			</div>
		</div>
			...
			<form action="knowledgeBoardList" method="post" name="ehddnrform"
								...
								<div id="knowledge_div3">
									...
									<div class="knowledge_select">
										<input class=knowledge_select2 type="text" maxlength="30"
											...
											class="knowledge_select3" type="button"
								...
								<div style="margin: 15px 0;">
									...
									<ul class="knowledge_ul" style="float: right; display: inline;">
										<li><input id="knowledge_button" type="button"
											value="QUESTION WRITE" onclick="knowledgeWriteForm();"></li>
									</ul>
								</div>
								<%
				...
				<c:forEach var="dto" items="${dtos}">
					<div class="col-12" style="margin:0;padding:0;">
						<div class="card flex-md-row mb-4 shadow-sm h-md-250" style="margin:0;padding:0;">
							<div class="card-body d-flex flex-column align-items-start" style="margin:0;padding:3px 3px;">
								<table class="tbl-ex" style="width: 100%;">
									<tr id="${dto.knowledgeNumber}">
										<td style="max-width: 100%; word-break: break-all;">
											<p style="margin:0;" onclick="knowledgeDetailForm(${dto.knowledgeNumber});">
												<span style="background-color: #ffff00 !important; color:black !important"> 
												${dto.knowledgeReward}</span> &nbsp; &nbsp;
												<span><a href="#"><strong class="d-inline-block mb-2 text-success" style="font-size: 23px;margin:0;">${dto.knowledgeSubject}</strong></a></span>
												<c:if test="${userVO.memberId==dto.memberId}">
												<span style="float: right; margin-right: 3px;"><a href="knowledgeDeleteForm?knowledgeNumber=${dto.knowledgeNumber}&pageNum=${pageNum}&btn_select=${btn_select}">삭제</a></span>
					...
					<ul class="pagination" align="center" style="margin:auto auto;">
						<c:if test="${cnt>0}">
							...
							<c:if test="${startPage > pageBlock }">
								<li class="page-item"><a class="page-link" href="knowledgeBoardList?btn_select=${btn_select}&knowledgeCategory=${knowledgeCategory}"><i class="fa fa-angle-left"></i><i class="fa fa-angle-left"></i></a></li>
								<li class="page-item"><a class="page-link" href="knowledgeBoardList?pageNum=${startPage-pageBlock}&btn_select=${btn_select}&knowledgeCategory=${knowledgeCategory}"><i class="fa fa-angle-left"></i></a></li>
							</c:if>
							...
							<c:forEach var="i" begin="${startPage}" end="${endPage}">
								...
								<c:if test="${i!=currentPage}">
									<li class="page-item"><a class="page-link" href="knowledgeBoardList?pageNum=${i}&btn_select=${btn_select}&knowledgeCategory=${knowledgeCategory}">${i}</a></li>
								</c:if>
							</c:forEach>
							
							<!-- 끝 ▶▶  / 다음블록▶ -->
							<c:if test="${pageCount > endPage }">
								<li class="page-item"><a class="page-link" href="knowledgeBoardList?pageNum=${startPage + pageBlock}&btn_select=${btn_select}&knowledgeCategory=${knowledgeCategory}"><i class="fa fa-angle-right"></i></a></li>
								<li class="page-item"><a class="page-link" href="knowledgeBoardList?pageNum=${pageCount}&btn_select=${btn_select}&knowledgeCategory=${knowledgeCategory}"><i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a></li>
							</c:if>
						</c:if>
					</ul>
				</nav>

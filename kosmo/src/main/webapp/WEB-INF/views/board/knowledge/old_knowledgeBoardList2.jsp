...
function knowledgeBoardListsearch(){
	...
	<div class ="row" id="knowledge_div" style="width:100%; display:inline-block;">
		<div class="col-12" style="padding:0;">
			<div class="shop-sorting-data d-flex flex-wrap align-items-center justify-content-between" style="margin-bottom:0;border-bottom:2px solid black;">
		...
		<div style="width:100%;padding-top:10px;">
			...
			<div style="width:80%; float:right; margin:0 0 0 0" class="shop-products-area">

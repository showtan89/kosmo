...
function getknowledgelistJsonData(){
	...
	$.getJSON("KnowledgeListJson?knowledgeCategory="+knowledgeCategory, function(data){
		...
		$(data.dtos).each(
				...
				function(){			
					...
					str +='<span style="margin-left: 20px;">'+this.knowledgeCategory+'</span>&nbsp;&nbsp;<span style="margin-left: 20px;">'+this.knowledgeRegdate+'</span>';
		...
		var pageNum = data.pageNum;
			...
			if(cnt==0){
				...
				if(startPage > pageBlock){
					pagestr += '<li class="page-item"><a class="page-link" href="knowledgeBoardList?btn_select=${btn_select}&knowledgeCategory='+knowledgeCategory+'"><i class="fa fa-angle-left"></i><i class="fa fa-angle-left"></i></a></li>';
					pagestr += '<li class="page-item"><a class="page-link" href="knowledgeBoardList?pageNum='+startPage-pageBlock+'&btn_select=${btn_select}&knowledgeCategory='+knowledgeCategory+'"><i class="fa fa-angle-left"></i></a></li>';
				}
				for(var j=startPage; startPage<endPage;startPage++){
					if(j==currentPage){
						pagestr += '<li class="page-item"><a class="page-link"style="background-color: #28a745 !important; color: white !important">'+startPage+'</a></li>';
					} else {
						pagestr += '<li class="page-item"><a class="page-link" href="knowledgeBoardList?pageNum='+startPage+'&btn_select=${btn_select}&knowledgeCategory=${knowledgeCategory}">'+startPage+'</a></li>';
					}
				}
				
				if(pageCount > endPage){
					pagestr += '<li class="page-item"><a class="page-link" href="knowledgeBoardList?pageNum=${startPage + pageBlock}&btn_select=${btn_select}&knowledgeCategory=${knowledgeCategory}"><i class="fa fa-angle-right"></i></a></li>';
					pagestr += '<li class="page-item"><a class="page-link" href="knowledgeBoardList?pageNum=${pageCount}&btn_select=${btn_select}&knowledgeCategory=${knowledgeCategory}"><i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a></li>';
				}
				pagestr += '</ul>';
			}
